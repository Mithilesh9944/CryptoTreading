...
import com.kanha.repository.CoinRepo;
...
public class CoinServiceImpl implements ICoinService {
    ...
    //ObjectMapper is a class provided by the Jackson library in Java that is used to convert between Java objects and JSON.
    @Autowired
